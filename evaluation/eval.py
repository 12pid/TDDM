...
def evaluation(result, types, ann_path):
    ...
    OP_3, OR_3, OF1_3, CP_3, CR_3, CF1_3 = json_metric_top3(pred_json, ann_json, len(classes), types)

    # print(aps)
    # print("mAP: {:4f}".format((np.mean(aps))*100))
    # print("CP: {:4f}, CR: {:4f}, CF1 :{:4F}".format(CP, CR, CF1))
    # print("OP: {:4f}, OR: {:4f}, OF1 {:4F}".format(OP, OR, OF1))
    # print("CP_3: {:4f}, CR_3: {:4f}, CF1_3 :{:4F}".format(CP_3, CR_3, CF1_3))
    # print("OP_3: {:4f}, OR_3: {:4f}, OF1_3 {:4F}".format(OP_3, OR_3, OF1_3))
